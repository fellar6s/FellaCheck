...
[System.Text.Encoding]::UTF8.GetString([Convert]::FromBase64String($headerBase64)) | ForEach-Object { $line = $_; $padding = ' ' * (($windowWidth - $line.Length) / 2); Write-Host ($padding + $line) -ForegroundColor Yellow }
